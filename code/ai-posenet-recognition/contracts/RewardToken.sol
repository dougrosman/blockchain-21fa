...
contract RewardToken is ERC20 {
    ...
    string private myTokenName = 'WeArToken'; // 1. The name of your of your Token
    string private myTokenSymbol = 'WAT'; // 2. A 3-letter symbol, like a stock symbol
    uint256 private tokensForMe = 30; // 3. The amount of tokens you want to create for yourself
    uint256 private tokensForContract = 2000; // 4. The amount of tokens you want to give to the contract
    uint8 private myNumDecimals = 0; // 5. The number of decimal places, 0-18 (The ERC20 default is 18)
