...
async function predict() {
  ...
  const HOLD_THRESHOLD = 20; // how many times in a row a pose must be predicted in order to call it the winner

  let REWARD_AMOUNT = 10; // how many tokens you want to reward
